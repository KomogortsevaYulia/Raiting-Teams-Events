    ...
    <div class="row my-3">
        <div class="col-auto">
            ...
            <select
                    ...
                    @change="fetchEvents()"
            >
                <option v-for="direction in directions" :value="direction.id" v-bind:key="direction.id">
                    {{ direction.name }}
                </option>
            </select>
        </div>
        ...
        <div class="col-auto">
            ...
            <select
                    ...
                    @change="fetchEvents()"
            >
                <option v-for="st in status" :value="st.id" v-bind:key="st.id">{{ st.name }}</option>
            </select>
        </div>
    </div>
...
onBeforeMount(async () => {
    directions.value = await dictionaryStore.getFromDictionaryByClassID(DIRECTION);
