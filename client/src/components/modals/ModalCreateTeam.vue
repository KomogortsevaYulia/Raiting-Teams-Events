            ...
            <div class="modal-content px-3 py-4">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                        ...
                        <sup
                                v-if="teamObj != null && teamObj.is_archive != null && teamObj.is_archive"
                            ...
                            <div class="create-filds">
                                <div class="filds-area">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            >
                                                <option
                                                        ...
                                                        :value="direction.id" v-bind:key="direction.id"
                                                >
                                                    {{ direction.shortname }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        />
                                        <p v-if="isEditTeam && teamObj != null">{{ teamObj.document }}</p>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto" v-if="isEditTeam">
                                            <button
                                                    ...
                                                    @click="archiveTeam(teamObj?.id ?? -1, teamObj?.is_archive ?? false)"
...
async function handleFileUpload(event: { target: { files: File[]; }; }, document: boolean) {
