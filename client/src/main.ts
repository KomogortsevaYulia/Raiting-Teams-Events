...
import { faUser, faCalendarDays, faClose, faEdit, faArchive, faPencilSquare,
     faFileDownload, faCircleNotch, faPlus, faClock, faCheckCircle, faCircleXmark, faIdCardClip, faFilter} from '@fortawesome/free-solid-svg-icons'
...
library.add(faUser, faCalendarDays, faClose, faEdit, faArchive,
     ...
     faCircleXmark, faIdCardClip, faFilter)
