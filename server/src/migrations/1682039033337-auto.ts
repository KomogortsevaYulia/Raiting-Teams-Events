...
export class auto1682039033337 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "teams" ADD "is_archive" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "teams" ADD "cabinet" character varying`);
        await queryRunner.query(`ALTER TABLE "teams" ADD "charter_team" character varying`);
        await queryRunner.query(`ALTER TABLE "teams" ADD "document" character varying`);
    }
