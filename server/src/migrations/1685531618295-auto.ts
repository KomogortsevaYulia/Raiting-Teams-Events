...
export class auto1685531618295 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "form_fields" ADD "archive" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "forms" ADD "fields_id" text NOT NULL`);
    }
