...
export class auto1670203838600 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."teams_type_team_enum" AS ENUM('diraction', 'university', 'teams')`);
        await queryRunner.query(`CREATE TABLE "teams" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "creation_date" TIMESTAMP NOT NULL, "image" text NOT NULL, "tags" text NOT NULL, "description" character varying NOT NULL, "type_team" "public"."teams_type_team_enum" NOT NULL DEFAULT 'teams', "shortname" character varying NOT NULL, "id_parent" integer, CONSTRAINT "PK_7e5523774a38b08a6236d322403" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."functions_type_function_enum" AS ENUM('general', 'special')`);
        await queryRunner.query(`CREATE TABLE "functions" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "type_function" "public"."functions_type_function_enum" NOT NULL DEFAULT 'special', "team_id" integer, "roleIdId" integer, CONSTRAINT "PK_203889d2ae5a98ffc137739301e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "teams" ADD CONSTRAINT "FK_c0b0c479964469ab9fbbed02c8d" FOREIGN KEY ("id_parent") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "functions" ADD CONSTRAINT "FK_c8b15425a585fcedc6b1f7f734a" FOREIGN KEY ("roleIdId") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "functions" DROP CONSTRAINT "FK_c8b15425a585fcedc6b1f7f734a"`);
        await queryRunner.query(`ALTER TABLE "functions" DROP CONSTRAINT "FK_579f1e0cdab39bd43464fb882be"`);
        await queryRunner.query(`ALTER TABLE "teams" DROP CONSTRAINT "FK_c0b0c479964469ab9fbbed02c8d"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."functions_type_function_enum"`);
