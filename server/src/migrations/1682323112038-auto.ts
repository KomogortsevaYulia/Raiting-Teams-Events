...
export class auto1682323112038 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dictionary" ADD "class_name" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dictionary" DROP COLUMN "class_name"`);
        await queryRunner.query(`ALTER TABLE "dictionary" ADD "class" character varying`);
    }
