...
export class auto1670674251360 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "username" character varying DEFAULT '123'`);
        await queryRunner.query(`ALTER TABLE "users" ADD "password" character varying DEFAULT '123'`);
