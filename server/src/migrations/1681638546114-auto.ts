...
export class auto1681638546114 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."events_direction_enum_old" AS ENUM('Культурно-массовая деятельность', 'Общественная деятельность', 'Научная деятельность', 'Спортивная деятельность', 'Учебная деятельность')`);
